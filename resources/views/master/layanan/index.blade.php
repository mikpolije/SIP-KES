...
@section('pageContent')
    @include('master.layanan.modal.add')
    @if (!empty($data['list']))
        @include('master.layanan.modal.edit')
    @endif
                ...
                <div class="card-body">
                    <div class="d-sm-flex d-block align-items-center justify-content-between mb-7">
                        <div class="mb-3 mb-sm-0">
                            <div class="card-title">Master Layanan</div>
                        </div>
                            ...
                            <tbody>
                                @forelse ($data['list'] as $key => $item)
                                    <tr>
                                        ...
                                        <td>{{ number_format($item->tarif_layanan, 0, '.', '.') }}</td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#modalEdit-{{$key}}" class="btn btn-warning">
                                ...
                                @empty
                                    <tr class="text-center">
                                        <td colspan="3">Belum Ada Layanan yang Tersedia.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
