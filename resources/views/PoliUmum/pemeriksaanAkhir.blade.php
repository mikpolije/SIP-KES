...
@section('pageContent')
    ...
    <!-- Modal Pemeriksaan Fisik dengan Canvas -->
        <!-- Fabric.js -->
                ...
                <!-- Pemeriksaan Fisik Section (Tanpa Modal) -->
                <div class="card shadow-sm p-4 mb-4">
                <h5 class="fw-bold mb-4">Pemeriksaan Fisik</h5>
                <div class="row">
                    <!-- Canvas & Toolbar -->
                    ...
                    <div class="col-md-5">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="bagianDiperiksa" name="bagian_diperiksa" placeholder="Ketik di sini">
                        </div>
                        <div class="mb-3">
