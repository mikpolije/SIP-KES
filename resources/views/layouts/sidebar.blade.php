    ...
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
            ...
            <ul class="first-level collapse {{ request()->is('main/laporankunjungan', 'main/laporankia', 'laporan*') ? 'show' : '' }}"
                ...
                <!-- Submenu Poli Umum -->
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow {{ request()->is('laporan/poliumum/*') ? 'active' : '' }}"
                    ...
                    <ul class="second-level collapse {{ request()->is('laporan/poliumum/*') ? 'show' : '' }}">
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->is('laporan/poliumum/penyakit-terbanyak') ? 'active' : '' }}"
                                href="{{ route('laporan.poli.penyakit_terbanyak') }}">
                                10 Besar Penyakit
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->is('laporan/poliumum/kunjungan') ? 'active' : '' }}"
