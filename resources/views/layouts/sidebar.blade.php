...
.brand-logo {
  padding-top: 25px;
  padding-bottom: 25px;
  padding-left: 25px; /* Memberi jarak antara logo dan tepi kiri */
}
...
.logo-img {
  display: flex;
  justify-content: flex-start; /* Membuat logo rata kiri */
  align-items: center;
}
</style>
    ...
    <nav class="sidebar-nav scroll-sidebar" data-simplebar>
      <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
          <a class="sidebar-link has-arrow {{ request()->is('') ? 'active' : '' }}" href="javascript:void(0)" aria-expanded="false">
            <span class="d-flex">
        ...
        <li class="sidebar-item">
          <a class="sidebar-link has-arrow {{ request()->is('') ? 'active' : '' }}" href="javascript:void(0)" aria-expanded="false">
            ...
            <span class="hide-menu">Persuaratan</span>
          </a>
          <ul aria-expanded="false" class="collapse first-level {{ request()->is('') ? 'in' : '' }}">
            <li class="sidebar-item">
              <a class="sidebar-link {{ request()->is('') ? 'active' : '' }}" href="/" aria-expanded="false">
