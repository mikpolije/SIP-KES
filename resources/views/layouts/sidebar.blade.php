    ...
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
            ...
            <ul class="first-level collapse {{ request()->is('main/laporankunjungan', 'main/laporankia', 'laporan*') ? 'show' : '' }}"
                ...
                <!-- Sidebar Item for Laporan Poli Umum -->
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow d-flex justify-content-between align-items-center {{ request()->is('laporan/poliumum') || request()->is('laporan/poliumum/*') ? 'active' : '' }}"
                        href="#" data-bs-toggle="collapse"
                        aria-expanded="{{ request()->is('laporan/poliumum/*') ? 'true' : 'false' }}"
                    ...
                    <ul id="submenu-laporan-poliumum"
                        class="second-level collapse {{ request()->is('laporan/poliumum/*') ? 'show' : '' }}"
                        aria-expanded="{{ request()->is('laporan/poliumum/*') ? 'true' : 'false' }}">

                        <!-- 10 Besar Penyakit -->
                        <li class="sidebar-item">
                            <a class="sidebar-link ps-5 {{ request()->is('laporan/poliumum/penyakit-terbanyak') ? 'active' : '' }}"
                                href="{{ route('laporan.poli.penyakit_terbanyak') }}">
                                <i class="ti ti-circle"></i>
                        ...
                        <!-- Kunjungan Poli Umum -->
                        <li class="sidebar-item">
                            <a class="sidebar-link ps-5 {{ request()->is('laporan/poliumum/kunjungan') ? 'active' : '' }}"
                                href="{{ route('laporan.poli.kunjungan') }}">
                                <i class="ti ti-circle"></i>
