...
<nav class="sidebar-nav scroll-sidebar" data-simplebar>
  <ul id="sidebarnav">
    ...
    <li class="sidebar-item">
      ...
      <ul
        class="first-level {{ request()->is('main/polikia') || request()->is('main/poliumum') || request()->is('main/rawat-inap') ? 'in' : '' }} collapse"
        aria-expanded="false">
        <li class="sidebar-item">
    ...
    <li class="sidebar-item">
      <a class="sidebar-link {{ request()->is('doctors') ? 'active' : '' }}" href="{{ route('doctors.index') }}"
        aria-expanded="false">
        <span class="d-flex">
