...
<nav class="sidebar-nav scroll-sidebar" data-simplebar>
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
            ...
            <ul id="menu-pemeriksaan"
                class="sidebar-menu collapse first-level {{ request()->is('main/poliumum*') || request()->is('main/layanan*') || request()->is('main/rawat-inap*') || request()->is('/') ? 'show' : '' }}">
                {{-- POLI UMUM --}}
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow {{ request()->is('main/poliumum*') ? 'active' : '' }}"
                        href="javascript:void(0)" data-bs-toggle="collapse" data-bs-target="#submenu-poliumum"
                    ...
                    <ul id="submenu-poliumum"
                        class="sidebar-submenu collapse second-level {{ request()->is('main/poliumum*') ? 'show' : '' }}"
                ...
                request()->is('surat-keterangan-sakit*') || request()->is('surat-kontrol') ||
                request()->is('main/blog-detail');
                @endphp

                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow {{ $isPersuratanActive ? 'active' : '' }}"
                        href="javascript:void(0)" aria-expanded="{{ $isPersuratanActive ? 'true' : 'false' }}">
                        <span class="d-flex">
                    ...
                    <ul class="first-level collapse {{ $isPersuratanActive ? 'in' : '' }}"
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->is('surat-kontrol') ? 'active' : '' }}"
                                href="/surat-kontrol">
                                <div class="round-16 d-flex align-items-center justify-content-center">
                                    <i class="ti ti-circle"></i>
                                </div>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow {{ request()->is('dokter') ? 'active' : '' }}"
