...
<div class="card-body">
    <form>
        ...
        <div class="mb-4">
            ...
            <div class="mb-3">
                ...
                <div class="d-inline-block mx-2">
                    <button type="button" class="btn btn-primary btn-sm">Memberikan</button>
                    <button type="button" class="btn btn-outline-secondary btn-sm">Tidak Memberikan</button>
                </div>
            ...
            <div class="row g-2 mb-3">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="Hubungan">
                </div>
            </div>
        </div>
        ...
        <div class="mb-4">
            ...
            <div class="form-check mb-3">
                <input class="form-check-input" type="checkbox" id="consent6">
                <label class="form-check-label" for="consent6">
                    Saya <span class="mx-2">
                        <button type="button" class="btn btn-primary btn-sm">Mengizinkan</button>
                        <button type="button" class="btn btn-outline-secondary btn-sm">Tidak Mengizinkan</button>
            ...
            <div class="form-check mb-3">
                <input class="form-check-input" type="checkbox" id="consent7">
            ...
            <div class="form-check mb-3">
                <input class="form-check-input" type="checkbox" id="consent8">
