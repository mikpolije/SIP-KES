...
@section('pageContent')
        ...
        @include('layouts.breadcrumb', ['title' => 'Modals', 'subtitle' => 'Home'])
          <div class="row">
            <div class="col-12">
              <!-- start Modal Sizes -->
              <div class="card">
                          ...
                          <div class="modal-body">
                            <div class="text-center mt-2 mb-4">
                              <a href="/main/index" class="text-success">
                                <span>
                                  <img src="{{ URL::asset('build/images/logos/favicon.png') }}" class="me-3 img-fluid"
                                    alt="modernize-img" />
                                </span>
                              </a>
                            </div>
                      ...
                      <div class="modal-dialog modal-dialog-scrollable modal-lg">
                        <div class="modal-content">
                          <div class="modal-body">
                            <div class="text-center mt-2 mb-4">
                              <a href="/main/index" class="text-success">
                                <span><img src="{{ URL::asset('build/images/logos/favicon.png') }}" class="me-3 img-fluid"
                                    alt="modernize-img" />
                                </span>
                              </a>
                            </div>
