          ...
          <div class="owl-carousel counter-carousel owl-theme">
              ...
              <div class="card border-0 zoom-in bg-primary-subtle shadow-none">
                <div class="card-body">
                  <div class="text-center">
                    <img src="{{ URL::asset('build/images/svgs/icon-user-male.svg') }}" width="50" height="50" class="mb-3"
                      alt="modernize-img" />
            ...
            <div class="item">
              <div class="card border-0 zoom-in bg-warning-subtle shadow-none">
                <div class="card-body">
                  <div class="text-center">
                    <img src="{{ URL::asset('build/images/svgs/icon-briefcase.svg') }}" width="50" height="50" class="mb-3"
                      alt="modernize-img" />
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center mb-7 pb-2">
                    <div class="me-3 pe-1">
                      <img src="{{ URL::asset('build/images/profile/user-2.jpg') }}" class="shadow-warning rounded-2" alt="modernize-img"
                        width="72" height="72" />
                    </div>
                    <div>
              ...
              <div class="card text-bg-primary border-0 w-100">
                <div class="card-body pb-0">
                  ...
                  <div class="text-center mt-3">
                    <img src="{{ URL::asset('build/images/backgrounds/piggy.png') }}" class="img-fluid" alt="modernize-img" />
                  </div>
                </div>
                      ...
                      <tbody class="border-top">
                        ...
                        <tr>
                          <td class="ps-0">
                            <div class="d-flex align-items-center">
                              <div class="me-2 pe-1">
                                <img src="{{ URL::asset('build/images/profile/user-7.jpg') }}" class="rounded-circle" width="40"
                                  height="40" alt="modernize-img" />
                              </div>
                              <div>
                        ...
                        <tr>
                          <td class="border-0 ps-0">
                            <div class="d-flex align-items-center">
                              <div class="me-2 pe-1">
                                <img src="{{ URL::asset('build/images/profile/user-8.jpg') }}" class="rounded-circle" width="40"
                                  height="40" alt="modernize-img" />
                              </div>
                              <div>
