...
@section('pageContent')
        ...
        @include('layouts.breadcrumb', ['title' => 'checkout', 'subtitle' => 'Home'])
          <div class="checkout">
            <div class="card">
                ...
                <div class="wizard-content">
                  <form action="#" class="tab-wizard wizard-circle">
                            ...
                            <tr>
                              <td class="border-bottom-0">
                                <div class="d-flex align-items-center gap-3 overflow-hidden">
                                  <img src="{{ URL::asset('build/images/products/s11.jpg') }}" alt="matdash-img" class="img-fluid rounded"
                                    width="80">
                                  <div>
                        ...
                        <div class="payment-option btn-group-active  card shadow-none border">
                          <div class="card-body p-4">
                            ...
                            <div class="row">
                                  ...
                                  <div class="position-relative mb-3 w-100 form-check btn-custom-fill ps-0">
                                    ...
                                    <label class="btn btn-outline-primary mb-0 p-3 rounded ps-5 w-100" for="btnradio3">
                                      <div class="d-flex align-items-center">
                                        ...
                                        <img src="{{ URL::asset('build/images/svgs/paypal.svg') }}" alt="matdash-img" class="img-fluid ms-auto">
                                      </div>
                                    </label>
                                  </div>
                                  <div class="position-relative mb-3 form-check btn-custom-fill ps-0">
                                    ...
                                    <label class="btn btn-outline-primary mb-0 p-3 rounded ps-5 w-100" for="btnradio4">
                                      <div class="d-flex align-items-center">
                                        ...
                                        <img src="{{ URL::asset('build/images/svgs/mastercard.svg') }}" alt="matdash-img" class="img-fluid ms-auto">
                                      </div>
                                    </label>
                                  </div>
                              ...
                              <div class="col-lg-4">
                                <img src="{{ URL::asset('build/images/products/payment.svg') }}" alt="matdash-img" class="img-fluid">
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <section class="payment-method text-center">
                      ...
                      <img src="{{ URL::asset('build/images/products/payment-complete.svg') }}" alt="matdash-img" class="img-fluid mb-4"
                        width="350">
                      <p class="mb-0 fs-2">We will send you a notification<br>within 2 days when it ships.</p>
                      <div class="d-sm-flex align-items-center justify-content-between my-4">
                        <a href="/main/eco-shop" class="btn btn-success d-block mb-2 mb-sm-0">Continue Shopping</a>
...
@section('scripts')
  ...
  <script src="{{ URL::asset('build/js/apps/ecommerce.js') }}"></script>
@endsection
