    ...
    <div class="container-fluid">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="button" class="btn btn-primary form-control" name="cari_data_pendaftaran"
                            id="cari_data_pendaftaran" value="Cari">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <textarea name="subjective" id="subjective" class="form-control" rows="15"
                            placeholder="Ketik subjective / keluhan di sini"></textarea>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="d-flex justify-content-end mb-4">
            <button type="button" class="btn btn-primary" id="submit_layanan"><i class="ti ti-device-floppy"></i>
                Submit</button>
        </div>
    </div>
@endsection
