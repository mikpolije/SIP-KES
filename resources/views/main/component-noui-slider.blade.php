...
@section('css')
<link rel="stylesheet" href="{{ URL::asset('build/libs/nouislider-orxe/distribute/nouislider.min.css') }}">
@endsection

@section('pageContent')

        @include('layouts.breadcrumb', ['title' => 'Noui-Slider', 'subtitle' => 'Home'])
          <div class="row">
...
@section('scripts')
  ...
  <script src="{{ URL::asset('build/libs/nouislider-orxe/distribute/nouislider.min.js') }}"></script>
  <script src="{{ URL::asset('build/js/plugins/nouislider-init.js') }}"></script>
@endsection
