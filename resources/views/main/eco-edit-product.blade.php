...
@section('pageContent')
        ...
        @include('layouts.breadcrumb', ['title' => 'Edit Product', 'subtitle' => 'Home'])
                    ...
                    <table class="table mb-0 align-middle">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <img src="{{ URL::asset('build/images/profile/user-11.jpg') }}" class="rounded-circle" width="30"
                                height="30" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <img src="{{ URL::asset('build/images/profile/user-8.jpg') }}" class="rounded-circle" width="30"
                                height="30" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <img src="{{ URL::asset('build/images/profile/user-3.jpg') }}" class="rounded-circle" width="30"
                                height="30" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <img src="{{ URL::asset('build/images/profile/user-4.jpg') }}" class="rounded-circle" width="30"
                                height="30" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <img src="{{ URL::asset('build/images/profile/user-5.jpg') }}" class="rounded-circle" width="30"
                                height="30" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <img src="{{ URL::asset('build/images/profile/user-6.jpg') }}" class="rounded-circle" width="30"
                                height="30" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <img src="{{ URL::asset('build/images/profile/user-7.jpg') }}" class="rounded-circle" width="30"
                                height="30" />
                              <div class="ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <img src="{{ URL::asset('build/images/profile/user-10.jpg') }}" class="rounded-circle" width="30"
                                height="30" />
                              <div class="ms-3">
...
@section('scripts')
  ...
  <script src="{{ URL::asset('build/js/apps/edit-product.js') }}"></script>
@endsection