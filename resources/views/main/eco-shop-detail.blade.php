...
@section('pageContent')
        ...
        @include('layouts.breadcrumb', ['title' => 'Product Detail', 'subtitle' => 'Home'])
                  ...
                  <div class="col-lg-6">
                    <div id="sync1" class="owl-carousel owl-theme">
                      <div class="item rounded-4 overflow-hidden">
                        <img src="{{ URL::asset('build/images/products/s1.jpg') }}" alt="modernize-img" class="img-fluid">
                      </div>
                      <div class="item rounded-4 overflow-hidden">
                        <img src="{{ URL::asset('build/images/products/s2.jpg') }}" alt="modernize-img" class="img-fluid">
                      </div>
                      <div class="item rounded-4 overflow-hidden">
                        <img src="{{ URL::asset('build/images/products/s3.jpg') }}" alt="modernize-img" class="img-fluid">
                      </div>
                      <div class="item rounded-4 overflow-hidden">
                        <img src="{{ URL::asset('build/images/products/s4.jpg') }}" alt="modernize-img" class="img-fluid">
                      </div>
                      <div class="item rounded-4 overflow-hidden">
                        <img src="{{ URL::asset('build/images/products/s5.jpg') }}" alt="modernize-img" class="img-fluid">
                      </div>
                      <div class="item rounded-4 overflow-hidden">
                        <img src="{{ URL::asset('build/images/products/s6.jpg') }}" alt="modernize-img" class="img-fluid">
                      </div>
                      <div class="item rounded-4 overflow-hidden">
                        <img src="{{ URL::asset('build/images/products/s7.jpg') }}" alt="modernize-img" class="img-fluid">
                      </div>
                      <div class="item rounded-4 overflow-hidden">
                        <img src="{{ URL::asset('build/images/products/s8.jpg') }}" alt="modernize-img" class="img-fluid">
                      </div>
                      <div class="item rounded-4 overflow-hidden">
                        <img src="{{ URL::asset('build/images/products/s9.jpg') }}" alt="modernize-img" class="img-fluid">
                      </div>
                      <div class="item rounded-4 overflow-hidden">
                        <img src="{{ URL::asset('build/images/products/s10.jpg') }}" alt="modernize-img" class="img-fluid">
                      </div>
                      <div class="item rounded-4 overflow-hidden">
                        <img src="{{ URL::asset('build/images/products/s11.jpg') }}" alt="modernize-img" class="img-fluid">
                      </div>
                      <div class="item rounded-4 overflow-hidden">
                        <img src="{{ URL::asset('build/images/products/s12.jpg') }}" alt="modernize-img" class="img-fluid">
                      </div>
                    </div>
                  ...
                  <div class="col-lg-6">
                    <div class="shop-content">
                      ...
                      <p class="mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ex arcu, tincidunt
                        bibendum felis.</p>
                      <h4 class="mb-3"><del class="fs-5 text-muted">$350</del> $275</h4>
                      <div class="d-flex align-items-center gap-8 pb-4 border-bottom">
                        <ul class="list-unstyled d-flex align-items-center mb-0">
                          ...
                          <li><a  href="javascript:void(0)"><i class="ti ti-star text-warning fs-4"></i></a>
                          </li>
                        </ul>
                      ...
                      <div class="d-flex align-items-center gap-7 pb-7 mb-7 border-bottom">
                        ...
                        <div class="input-group input-group-sm rounded">
                          ...
                          <input type="text"
                            ...
                            value="1">
                          <button class="btn min-width-40 py-0 border border-muted fs-5 border-start-0 text-muted add"
                        ...
                        <div class="card shadow-none border w-100 mb-7 mb-lg-0">
                          <div class="card-body text-center p-4 d-flex flex-column justify-content-center">
                            ...
                            <ul class="list-unstyled d-flex align-items-center justify-content-center mb-0">
                              ...
                              <li><a class="me-1" href="javascript:void(0)"><i
                                    class="ti ti-star text-warning fs-6"></i></a></li>
                              <li><a  href="javascript:void(0)"><i class="ti ti-star text-warning fs-6"></i></a>
                              </li>
                            </ul>
                          </div>
                        </div>
            ...
            <div class="related-products pt-7">
              ...
              <div class="row">
                <div class="col-sm-6 col-xl-3">
                  <div class="card hover-img overflow-hidden">
                    <div class="position-relative">
                      <a href="javascript:void(0)"><img src="{{ URL::asset('build/images/products/s2.jpg') }}"
                ...
                <div class="col-sm-6 col-xl-3">
                  <div class="card hover-img overflow-hidden">
                    <div class="position-relative">
                      <a href="javascript:void(0)"><img src="{{ URL::asset('build/images/products/s6.jpg') }}"
                          class="card-img-top" alt="modernize-img"></a>
                    </div>
                    <div class="card-body pt-3 p-4">
...
@section('scripts')
  ...
  <script src="{{ URL::asset('build/js/apps/productDetail.js') }}"></script>
@endsection