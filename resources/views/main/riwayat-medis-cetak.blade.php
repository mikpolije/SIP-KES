...
<body class="p-2">
    ...
    <div class="">
        ...
        @if($asessmen_awal->where('id_pendaftaran', $id_pendaftaran)->count() > 0)
        <div class="card mt-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach($asessmen_awal->where('id_pendaftaran', $id_pendaftaran) as $detail)
                            <tr>
        ...
        @if($asuhan_keperawatan->where('id_pendaftaran', $id_pendaftaran)->count() > 0)
        <div class="card mt-4">
            <div class="card-header bg-secondary text-white">
                Daftar Asuhan Keperawatan
            </div>
            <div class="card-body">
                <div class="table-responsive" style="overflow-x:auto">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach($asuhan_keperawatan->where('id_pendaftaran', $id_pendaftaran) as $index => $a)
                            <tr>
                                <td>{{ $index + 1 }}</td>
        ...
        <!-- Daftar CPPT -->
        @if($cppt->where('id_pendaftaran', $id_pendaftaran)->count() > 0)
        <div class="card mt-4">
            <div class="card-header bg-secondary text-white">
                Daftar CPPT
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach($cppt->where('id_pendaftaran', $id_pendaftaran) as $detail)
                            <tr>
                                <td>{{ $detail->s ?? '-' }}</td>
                                <td>{{ $detail->o ?? '-' }}</td>
                                <td>{{ $detail->a ?? '-' }}</td>
        ...
        @if($pemeriksaan->where('id_pendaftaran', $id_pendaftaran)->count() > 0)
        <div class="card mt-4">
            <div class="card-header bg-secondary text-white">
                Daftar Pemeriksaan Poli Umum
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach($pemeriksaan->where('id_pendaftaran', $id_pendaftaran) as $detail)
                            <tr>
        ...
        <!-- Daftar Pemeriksaan Poli Umum -->
        @if($pemeriksaan_ugd->where('id_pendaftaran', $id_pendaftaran)->count() > 0)
        <div class="card mt-4">
            <div class="card-header bg-secondary text-white">
        ...
        <!-- Daftar Triase -->
        @if($triase->where('id_pendaftaran', $id_pendaftaran)->count() > 0)
        <div class="card mt-4">
            <div class="card-header bg-secondary text-white">
                Daftar Triase
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach($triase->where('id_pendaftaran', $id_pendaftaran) as $detail)
                            <tr>
        ...
        <!-- Daftar Layanan KIA -->
        @if($layanan_kia->where('id_pendaftaran', $id_pendaftaran)->count() > 0)
        <div class="card mt-4">
            <div class="card-header bg-secondary text-white">
                Daftar Layanan KIA
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach($layanan_kia->where('id_pendaftaran', $id_pendaftaran) as $item)
                            <tr>
