...
@section('pageContent')
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card overflow-hidden hover-img">
                <div class="position-relative">
                  <a href="/main/blog-detail"><img src="{{ URL::asset('build/images/blog/blog-img6.jpg') }}"
                ...
                <div class="card-body p-4">
                  ...
                  <a class="d-block my-4 fs-5 text-dark fw-semibold link-primary" href="/main/blog-detail">As yen
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card overflow-hidden hover-img">
                <div class="position-relative">
                  <a href="/main/blog-detail"><img src="{{ URL::asset('build/images/blog/blog-img11.jpg') }}"
                      class="card-img-top" alt="modernize-img"></a>
                  <span
                    class="badge text-bg-light fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                    min Read</span>
                ...
                <div class="card-body p-4">
                  ...
                  <a class="d-block my-4 fs-5 text-dark fw-semibold link-primary" href="/main/blog-detail">Intel loses
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card overflow-hidden hover-img">
                <div class="position-relative">
                  <a href="/main/blog-detail"><img src="{{ URL::asset('build/images/blog/blog-img8.jpg') }}"
                      class="card-img-top" alt="modernize-img"></a>
                  <span
                    class="badge text-bg-light fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                    min Read</span>
                ...
                <div class="card-body p-4">
                  ...
                  <a class="d-block my-4 fs-5 text-dark fw-semibold link-primary" href="/main/blog-detail">COVID
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card overflow-hidden hover-img">
                <div class="position-relative">
                  <a href="/main/blog-detail"><img src="{{ URL::asset('build/images/blog/blog-img5.jpg') }}"
                      class="card-img-top" alt="modernize-img"></a>
                  <span
                    class="badge text-bg-light fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                    min Read</span>
                ...
                <div class="card-body p-4">
                  ...
                  <a class="d-block my-4 fs-5 text-dark fw-semibold link-primary" href="/main/blog-detail">Streaming
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card overflow-hidden hover-img">
                <div class="position-relative">
                  <a href="/main/blog-detail"><img src="{{ URL::asset('build/images/blog/blog-img3.jpg') }}"
                      class="card-img-top" alt="modernize-img"></a>
                  <span
                    class="badge text-bg-light fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                    min Read</span>
                ...
                <div class="card-body p-4">
                  ...
                  <a class="d-block my-4 fs-5 text-dark fw-semibold link-primary" href="/main/blog-detail">Apple is
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card overflow-hidden hover-img">
                <div class="position-relative">
                  <a href="/main/blog-detail"><img src="{{ URL::asset('build/images/blog/blog-img2.jpg') }}"
                      class="card-img-top" alt="modernize-img"></a>
                  <span
                    class="badge text-bg-light fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                    min Read</span>
                ...
                <div class="card-body p-4">
                  <span class="badge text-bg-light fs-2 py-1 px-2 lh-sm  mt-3">Lifestyle</span>
                  <a class="d-block my-4 fs-5 text-dark fw-semibold link-primary" href="/main/blog-detail">After
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card overflow-hidden hover-img">
                <div class="position-relative">
                  <a href="/main/blog-detail"><img src="{{ URL::asset('build/images/blog/blog-img4.jpg') }}"
                      class="card-img-top" alt="modernize-img"></a>
                  <span
                    class="badge text-bg-light fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                    min Read</span>
                ...
                <div class="card-body p-4">
                  <span class="badge text-bg-light fs-2 py-1 px-2 lh-sm  mt-3">Design</span>
                  <a class="d-block my-4 fs-5 text-dark fw-semibold link-primary" href="/main/blog-detail">Why Figma is
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card overflow-hidden hover-img">
                <div class="position-relative">
                  <a href="/main/blog-detail"><img src="{{ URL::asset('build/images/blog/blog-img1.jpg') }}"
                      class="card-img-top" alt="modernize-img"></a>
                  <span
                    class="badge text-bg-light fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                    min Read</span>
                ...
                <div class="card-body p-4">
                  <span class="badge text-bg-light fs-2 py-1 px-2 lh-sm  mt-3">Gadget</span>
                  <a class="d-block my-4 fs-5 text-dark fw-semibold link-primary" href="/main/blog-detail">Garmins
