...
@section('pageContent')
        ...
        @include('layouts.breadcrumb', ['title' => 'Shop', 'subtitle' => 'Home'])
              ...
              <div class="card-body p-4 pb-0">
                ...
                <div class="row">
                  <div class="col-sm-6 col-xxl-4">
                    <div class="card hover-img overflow-hidden">
                      <div class="position-relative">
                        <a href="/main/eco-shop-detail"><img src="{{ URL::asset('build/images/products/s11.jpg') }}"
                  ...
                  <div class="col-sm-6 col-xxl-4">
                    <div class="card hover-img overflow-hidden">
                      <div class="position-relative">
                        <a href="/main/eco-shop-detail"><img src="{{ URL::asset('build/images/products/s5.jpg') }}"
                            class="card-img-top" alt="modernize-img"></a>
                        <a href="javascript:void(0)"
                          class="text-bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                          data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i
                  ...
                  <div class="col-sm-6 col-xxl-4">
                    <div class="card hover-img overflow-hidden">
                      <div class="position-relative">
                        <a href="/main/eco-shop-detail"><img src="{{ URL::asset('build/images/products/s6.jpg') }}"
                            class="card-img-top" alt="modernize-img"></a>
                        <a href="javascript:void(0)"
                          class="text-bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                          data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i
                  ...
                  <div class="col-sm-6 col-xxl-4">
                    <div class="card hover-img overflow-hidden">
                      <div class="position-relative">
                        <a href="/main/eco-shop-detail"><img src="{{ URL::asset('build/images/products/s4.jpg') }}"
                            class="card-img-top" alt="modernize-img"></a>
                        <a href="javascript:void(0)"
                          class="text-bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                          data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i
                  ...
                  <div class="col-sm-6 col-xxl-4">
                    <div class="card hover-img overflow-hidden">
                      <div class="position-relative">
                        <a href="/main/eco-shop-detail"><img src="{{ URL::asset('build/images/products/s10.jpg') }}"
                            class="card-img-top" alt="modernize-img"></a>
                        <a href="javascript:void(0)"
                          class="text-bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                          data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i
                  ...
                  <div class="col-sm-6 col-xxl-4">
                    <div class="card hover-img overflow-hidden">
                      <div class="position-relative">
                        <a href="/main/eco-shop-detail"><img src="{{ URL::asset('build/images/products/s7.jpg') }}"
                            class="card-img-top" alt="modernize-img"></a>
                        <a href="javascript:void(0)"
                          class="text-bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                          data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i
                  ...
                  <div class="col-sm-6 col-xxl-4">
                    <div class="card hover-img overflow-hidden">
                      <div class="position-relative">
                        <a href="/main/eco-shop-detail"><img src="{{ URL::asset('build/images/products/s8.jpg') }}"
                            class="card-img-top" alt="modernize-img"></a>
                        <a href="javascript:void(0)"
                          class="text-bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                          data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i
                  ...
                  <div class="col-sm-6 col-xxl-4">
                    <div class="card hover-img overflow-hidden">
                      <div class="position-relative">
                        <a href="/main/eco-shop-detail"><img src="{{ URL::asset('build/images/products/s9.jpg') }}"
                            class="card-img-top" alt="modernize-img"></a>
                        <a href="javascript:void(0)"
                          class="text-bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                          data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i
                  ...
                  <div class="col-sm-6 col-xxl-4">
                    <div class="card hover-img overflow-hidden">
                      <div class="position-relative">
                        <a href="/main/eco-shop-detail"><img src="{{ URL::asset('build/images/products/s3.jpg') }}"
                            class="card-img-top" alt="modernize-img"></a>
                        <a href="javascript:void(0)"
                          class="text-bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                          data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i
                  ...
                  <div class="col-sm-6 col-xxl-4">
                    <div class="card hover-img overflow-hidden">
                      <div class="position-relative">
                        <a href="/main/eco-shop-detail"><img src="{{ URL::asset('build/images/products/s1.jpg') }}"
                            class="card-img-top" alt="modernize-img"></a>
                        <a href="javascript:void(0)"
                          class="text-bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                          data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i
                  ...
                  <div class="col-sm-6 col-xxl-4">
                    <div class="card hover-img overflow-hidden">
                      <div class="position-relative">
                        <a href="/main/eco-shop-detail"><img src="{{ URL::asset('build/images/products/s12.jpg') }}"
                            class="card-img-top" alt="modernize-img"></a>
                        <a href="javascript:void(0)"
                          class="text-bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                          data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i
                  ...
                  <div class="col-sm-6 col-xxl-4">
                    <div class="card hover-img overflow-hidden">
                      <div class="position-relative">
                        <a href="/main/eco-shop-detail"><img src="{{ URL::asset('build/images/products/s2.jpg') }}"
                            class="card-img-top" alt="modernize-img"></a>
                        <a href="javascript:void(0)"
                          class="text-bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                          data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i
