                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            $('#searchNoRM').on('change', function() {
                                                let input = $(this).val();
                                                let no_rm = input.split(' - ')[0].trim(); // Ambil RM000001 saja
                                                ...
                                                if (no_rm) {
                                                    $.ajax({
                                                        ...
                                                        success: function(data) {
                                                            ...
                                                            $('#tempat_lahir_pasien').val(data
                                                                .tempat_lahir_pasien);
                                                            $('#kode_pos').val(data.kode_pos);
                                                            $('#rt').val(data.rt);
                                                            $('#rw').val(data.rw);
                                                            $('#tanggal_lahir_pasien').val(data
                                                                .tanggal_lahir_pasien);
                                                            $('#agama').val(data.agama);
                                                            $('#status_perkawinan').val(data
                                                                .status_perkawinan);
                                                            $('#pendidikan_pasien').val(data
                                                                .pendidikan_pasien);
                                                            $('#pekerjaan_pasien').val(data
                                                                .pekerjaan_pasien);
                                                            $('#kewarganegaraan').val(data
                                                                .kewarganegaraan);
                                                            $('#no_telepon_pasien').val(data
                                                                .no_telepon_pasien);
                                                            $('#nama_ibu_kandung').val(data
                                                                .nama_ibu_kandung);
                                                            $('#gol_darah').val(data.gol_darah);

                                                            // Data wali pasien (pastikan data.wali tidak null)
                                                            if (data.wali) {
                                                                $('#hubungan').val(data.wali
                                                                    .hubungan_dengan_pasien);
                                                                $('#nama_wali').val(data.wali
                                                                    .nama_wali);
                                                                $('#tlwali').val(data.wali
                                                                    .tanggal_lahir_wali);
                                                                $('#notelpwali').val(data.wali
                                                                    .no_telepon_wali);
                                                                $('#alamatwali').val(data.wali
                                                                    .alamat_wali);
                                                            } else {
                                                                $('#hubungan').val('');
                                                                $('#nama_wali').val('');
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control required" id="telepon" name="telepon"
                                        placeholder="08xxxxxxxxxx" oninput="validateNumeric(this, 13)" maxlength="13"
                                        required>
                                    <small class="error-message" id="telepon-error">Nomor telepon wali harus berupa 10-13
                                        digit angka</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="modal-content p-4 rounded-4 shadow-lg">
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <label class="form-label">Yang bertanda tangan di bawah ini, dr. Trik Hujan Dokter KLINIK
                                PRATAMA
