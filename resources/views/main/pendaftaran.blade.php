            ...
            <div class="card-body wizard-content">
                        ...
                        <div class="card-body wizard-content">
                            ...
                            <div class="step-indicator">
                                ...
                                <div class="step" id="step2-indicator">
                                    ...
                                    <div class="step-title">Pemeriksaan Awal</div>
                                    <div class="step-connector"></div>
                                </div>
                                ...
                                <div class="step" id="step4-indicator">
                                    ...
                                    <div class="step-title">Farmasi</div>
                                    <div class="step-connector"></div>
                                </div>
                                    ...
                                    <form id="registrationForm" novalidate>
                                        ...
                                        <form id="registrationForm" novalidate>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="norm"> No RM : <span
                                                                class="danger">*</span>
                                                        </label>
                                                        <input type="text" class="form-control required" id="norm"
                                                            name="norm" placeholder="Masukkan No. RM" />
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="alamatlengkap"> Alamat Lengkap :
                                                            <span class="danger">*</span>
                                                        </label>
                                                        <input type="text" class="form-control required"
                                                            id="alamatlengkap" name="alamatlengkap"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control required"
                                                            id="nik" name="nik" placeholder="16 digit"
                                                            oninput="validateNIK(this)" maxlength="16" required />
                                                        <small class="error-message" id="nik-error">NIK harus berupa 16
                                                            digit
                                                            angka</small>
                                                        <div class="invalid-feedback">
                                                            NIK harus diisi dengan 16 digit angka
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <small class="error-message" id="kodepos-error">Kode Pos harus
                                                            berupa
                                                            5 digit
                                                            angka</small>
                                                    </div>
                                                ...
                                                <div class="col-md-1">
                                                    <div class="mb-3">
                                                        ...
                                                        <small class="error-message" id="rt-error">RT harus berupa
                                                            angka</small>
                                                    </div>
                                                </div>
                                                <div class="col-md-1">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control required"
                                                            id="rw" name="rw"
                                                            oninput="validateNumeric(this, 3)" maxlength="3" />
                                                        <small class="error-message" id="rw-error">RW harus berupa
                                                            angka</small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select required" id="jeniskelamin"
                                                            name="jeniskelamin">
                                                            <option value="tidakdiketahui">Tidak Diketahui</option>
                                                            <option value="lakilaki">Laki-laki</option>
                                                            <option value="perempuan">Perempuan</option>
                                                            <option value="tidakdapatditentukan">Tidak dapat ditentukan
                                                            </option>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="agama">Agama: <span
                                                                class="danger">*</span></label>
                                                        <select class="form-select required" id="agama"
                                                            name="agama">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="perkawinan">Status Perkawinan:
                                                            <span class="danger">*</span></label>
                                                        <select class="form-select required" id="perkawinan"
                                                            name="perkawinan">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="pendidikan">Pendidikan: <span
                                                                class="danger">*</span></label>
                                                        <select class="form-select required" id="pendidikan"
                                                            name="pendidikan">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="pekerjaan">Pekerjaan: <span
                                                                class="danger">*</span></label>
                                                        <select class="form-select required" id="pekerjaan"
                                                            name="pekerjaan">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="kewarganegaraan">Kewarganegaraan:
                                                            <span class="danger">*</span></label>
                                                        <select class="form-select required" id="kewarganegaraan"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control required"
                                                            ...
                                                            oninput="validateTelepon(this)" maxlength="13" required>
                                                        <small class="error-message" id="telepon-error">Nomor telepon
                                                            harus
                                                            berupa 10-13
                                                            digit angka</small>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="goldar">Golongan Darah: <span
                                                                class="danger">*</span></label>
                                                        <select class="form-select required" id="goldar"
                                                            name="goldar">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="hubungan">Hubungan dengan Pasien:
                                                            <span class="danger">*</span></label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="notelpwali">Nomor Telepon Wali:
                                                            <span class="danger">*</span></label>
                                                        <input type="number" class="form-control required"
                                                            id="notelpwali" name="notelpwali" placeholder="08xxxxxxxxxx"
                                                            oninput="validateTelepon(this)" maxlength="13" required>
                                                        <small class="error-message" id="notelpwali-error">Nomor telepon
                                                            wali
                                                            harus berupa
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="layanan">Layanan <span
                                                                    class="danger">*</span></label>
                                                            <select class="form-select required" id="layanan"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="bayar">Cara Pembayaran <span
                                                                    class="danger">*</span></label>
                                                            <select class="form-select required" id="bayar"
                                                                name="bayar" required>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Ada beberapa field yang belum diisi dengan benar:</p>
                                                <ul id="errorList"></ul>
                                            </div>
                                ...
                                <section>
                                    ...
                                    <div class="card p-3 mb-3 shadow-sm">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="tanggalperiksa">Tanggal
                                                        Pemeriksaan</label>
                                                    <input type="date" class="form-control required"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="kunjunganasakit"> Kunjungan
                                                        Sakit</label>
                                    ...
                                    <div class="card p-3 mb-3 shadow-sm">
                                        <div class="row">
                                            <div class="col-md-2">
                                                ...
                                                <input type="text" class="form-control" id="noantian"
                                                    name="noantian">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label" for="nama">Nama</label>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <input type="text" class="form-control" id="no.rm"
                                                    name="no.rm">
                                            </div>
                                            <div class="col-md-2">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered mt-2">
                                                        ...
                                                        <tbody id="selected-icds-icd9">
                                                            <tr>
                                                                <td colspan="2" class="text-center text-muted">Belum
                                                                    ada Tindakan
                                                                    yang dipilih</td>
                                                            </tr>
                                                        </tbody>
                                                ...
                                                <div class="modal-body" id="physicalExamModalBody">
                                                    <div id="physicalExamDetails">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>Catatan Tambahan: Diperlukan pemeriksaan lanjutan dengan USG
                                                                Doppler
                                                            </li>
                                                        </ul>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select required" id="paymentMethod"
                                                    name="paymentMethod">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="discountCode">Kode Diskon (Opsional)
                                                    :</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="paymentNotes">Catatan Pembayaran
                                                    :</label>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="c-inputs-stacked">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="paidPartial">Bayar
                                                            Sebagian</label>
                                                    </div>
                                                    <div class="form-check">
                ...
                <div class="modal fade" id="modalSakit" tabindex="-1" aria-labelledby="modalSakitLabel"
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content p-4 rounded-4 shadow-lg">
                            <div class="modal-header border-0">
                                <h2 class="modal-title fw-bold text-primary" id="modalSakitLabel">Surat Keterangan Sakit
                                </h2>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form>
                                    ...
                                    <label class="form-label">Yang bertanda tangan di bawah ini, dr. Trik Hujan Dokter
                                        KLINIK PRATAMA
                                    ...
                                    <div class="mt-4">
                                        <label class="form-label">Pada pemeriksaan saat ini ternyata dalam keadaan sakit,
                                            sehingga
                                            perlu istirahat selama</label>
                                        <div style="display: inline-block; margin-left: 10px;">
                                            <input type="text" class="form-control" id="banyakHari"
                                                placeholder="" style="width: 50px; display: inline;">
                                        </div>
                                    ...
                                    <div class="mt-3" style="display: flex; align-items: center;">
                                        ...
                                        <input type="text" id="rangeCalendar" class="form-control"
                                            style="width: 300px;" placeholder="DD/MM/YYYY sampai DD/MM/YYYY">
                                    </div>
            ...
            `;
                ...
                <script>
                    ...
                    function validateNumeric(input, maxLength) {
                        ...
                        if (errorElement) {
                            if (value.length > 0 && maxLength && value.length !== maxLength) {
                                errorElement.style.display = 'block';
                                input.setCustomValidity(`Harus terdiri dari ${maxLength} digit angka`);
                            } else {
                                errorElement.style.display = 'none';
                                input.setCustomValidity('');
                            }
                    ...
                    function validateTelepon(input) {
                        ...
                        if (errorElement) {
                            if (value.length > 0 && (value.length < 10 || value.length > 13)) {
                                errorElement.style.display = 'block';
                                input.setCustomValidity('Nomor telepon harus terdiri dari 10-13 digit angka');
                            } else {
                                errorElement.style.display = 'none';
                                input.setCustomValidity('');
                            }
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        form.addEventListener('submit', function(event) {
                            ...
                            // Check NIK specifically
                            const nikInput = document.getElementById('nik');
                            if (!nikInput.value || nikInput.value.length !== 16) {
                                nikInput.classList.add('is-invalid');
                                showErrorModal(['NIK harus diisi dengan 16 digit angka']);
                                return false;
                            }
                                ...
                                requiredFields.forEach(field => {
                                    if (!field.checkValidity()) {
                                        const label = field.previousElementSibling.textContent.replace('*', '')
                                            .trim().replace(':', '');
                                        errors.push(`${label} belum diisi dengan benar`);
                                    }
                                });
                            ...
                            alert('Form valid! Lanjut ke halaman berikutnya.');
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        if (wizard) {
                            $(wizard).steps({
                                ...
                                onStepChanging: function(event, currentIndex, newIndex) {
                                    ...
                                    updateStepIndicator(currentIndex, newIndex);
                                    return true;
                                },
                        ...
                        function updateStepIndicator(currentIndex, newIndex) {
                            // Reset all steps
