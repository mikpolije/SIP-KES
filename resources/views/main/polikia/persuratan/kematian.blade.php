...
@section('pageContent')
    <div class="card bg-white card-custom p-4" id="surat">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10">
                <input type="time" id="waktu_masuk_rs" name="waktu_masuk_rs" class="form-control">
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10">
                <input type="time" id="waktu_kematian" name="waktu_kematian" class="form-control">
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10">
                <input type="text" id="tempat_kematian" name="tempat_kematian" class="form-control"
                    value="Klinik Insan Medika">
            </div>
        </div>
        ...
        <p>Demikian Surat Keterangan Kematian ini dibuat dengan sebenarnya untuk dapat dipergunakan sebagaimana mestinya.
        </p>

        <div class="text-end">
            <label for="tanggal_tanda_tangan" class="form-label">Jember,</label>
            <input type="date" id="tanggal_tanda_tangan" name="tanggal_tanda_tangan" class="form-control mb-2 ms-auto"
...
@section('scripts')
    ...
    <script>
            ...
            if (id_pendaftaran) {
                $.ajax({
                    ...
                    if (data.surat_kematian) {
                        ...
                        $('#penandatangan').val(data.surat_kematian.penandatangan)
                    }
        ...
        $('#btn-cetak').on('click', function(e) {
            ...
            const tanggalMasuk = formatTanggalIndonesia($('#tanggal_masuk_rs').val());
            const pukulMasuk = $('#waktu_masuk_rs').val();
            const tanggalMeninggal = formatTanggalIndonesia($('#tanggal_kematian').val());
            ...
            <body>
                <table class="header-table" style="width: 100%;">
                    <tr>
                        <td style="width: 80px;">
                            <img src="{{ asset('assets/klinik-insan.png') }}" alt="Logo Klinik">
                        </td>
                ...
                <p style="margin-bottom: 10px;">Saya yang bertanda tangan di bawah ini menyatakan bahwa:</p>
                ...
                <p style="margin-top: 20px; margin-bottom: 10px;"><strong>Telah Meninggal Dunia, pada:</strong></p>
                ...
                <p style="margin-top: 25px;">Demikian Surat Keterangan Kematian ini dibuat dengan sebenarnya untuk dapat dipergunakan sebagaimana mestinya.</p>
        ...
        function showErrorsOnFields(errors, id, scrollTop = true) {
            for (const [key, value] of Object.entries(errors)) {
                ...
                if (input.is(':radio') || input.is(':checkbox')) {
                    ...
                    lastRadio.closest('.form-check-inline, .form-check').after(
                        `<div class="text-danger text-sm" id="error-${key}">${value[0]}</div>`);
                } else {
