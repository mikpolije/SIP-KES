...
<div class="container-fluid">
    <div class="card w-100">
        <div class="card-body wizard-content">
            ...
            <h1 class="title1">Laporan UGD</h1>
            <style>
                .title1 {
                    ...
                    <div class="row mb-9 justify-content-end">
                        <div class="col-md-8 d-flex justify-content-end">
                            <button type="button" class="btn btn-warning btn-3d" style="margin-right: 10px;"
                                onclick="openPrintWindow()">Cetak</button>
                        </div>
                    </div>
            </section>
        </div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    res.data.forEach(item => {
                        labels.push(item.kondisi_saat_keluar ?? 'Tidak diketahui');
...
<script>
    function openPrintWindow() {
        ...
        const url = "{{ route('laporan_kunjungan.print') }}?" +
