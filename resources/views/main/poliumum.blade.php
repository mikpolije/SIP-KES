                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="texr" class="form-control required" id="notelpwali" name="notelpwali"
                                ...
                                <div class="d-flex align-items-center me-3">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="suratKeteranganDropdown">
                                            <li><a class="dropdown-item" href="#" value="suratketerangansehat">Surat
                                                    Keterangan Sehat</a></li>
                                            <li><a class="dropdown-item" href="#" value="suratketerangansakit">Surat
                                                    Keterangan Sakit</a></li>
                                            <li><a class="dropdown-item" href="#" value="generalconsent">General
                                                    Consent</a></li>
                                            <li><a class="dropdown-item" href="#" value="informedconsent">Informed
                                                    Consent</a></li>
                                        </ul>
                                    </div>
                                </div>
...
=======
>>>>>>> ec4cd7442e9cd77ba1ff17857248791b9cf38614
                        <div class="row">
                            <div class="col-md-2">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="diagnosis" id="diagnosis" rows="6" class="form-control"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="assesment" id="assesment" rows="6" class="form-control"
                                        placeholder="Ketik Assesment"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label" for="plan">Plan </label>
                                    <textarea name="plan" id="plan" rows="6" class="form-control"
