            ...
            <form action="#" class="validation-wizard wizard-circle mt-5">
                ...
                <section>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="card p-3 h-100">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <button class="btn btn-sm btn-secondary" data-bs-toggle="modal" data-bs-target="#addPhysicalExamModal">Tambah +</button>
                                </div>
                                <div class="table-responsive">
                        ...
                        <!-- Modal Tambah Pemeriksaan Fisik -->
                        <div class="modal fade" id="addPhysicalExamModal" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Tambah Pemeriksaan Fisik</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="examDescription" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                        <button type="button" class="btn btn-primary" onclick="addExam()">Simpan</button>
                                    </div>
                                </div>
                            </div>
                        </div>
